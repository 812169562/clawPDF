...
namespace clawPDF.Signature
{
    public static class Log
    {
        ...
        public static void Sign(string message)
        {
            var path = AppDomain.CurrentDomain.BaseDirectory + "logs/" + "sign" + $"//{Date.yyyyMMdd}";
            if (!System.IO.Directory.Exists(path))
            {
                System.IO.Directory.CreateDirectory(path);
            }
        ...
        public static void SignError(string message)
        {
            var path = AppDomain.CurrentDomain.BaseDirectory + "logs/" + "sign_error" + $"//{Date.yyyyMMdd}";
            if (!System.IO.Directory.Exists(path))
            {
                System.IO.Directory.CreateDirectory(path);
            }
